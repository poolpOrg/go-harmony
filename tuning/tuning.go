...
type Tuning interface {
	Frequency(uint, uint) float64
}

type TuningA440 struct{}
...
func NewA440() TuningA440 {
	return TuningA440{}
}

func (tuning TuningA440) Frequency(semitone uint, octave uint) float64 {
	return a440[octave][semitone%12]
}
